					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown05">
								<li><a class="dropdown-item" href="./ComBoardController?action=list">확진자 / 자가격리자</a></li>
...
<div class="container">
	<div class="con_txt">
		<form action="./ComBoardController" method="post" name="wfrm">
			<input type="hidden" name="action" value="write_ok1" />
