...
<%
	...
	String address[] = null;
	if( to.getAddress().equals( "" ) ) {
		address = new String[] { "", "" };
	} else {
		address = to.getAddress().split( "/" );
	}
...
<script type="text/javascript">
	...
	window.onload = function() {
		...
		document.getElementById('dbtn').onclick = function() {
			...
			document.wfrm.action = "./loginController?action=userdelete";
			document.wfrm.submit();
		};
	...
	function openNICKChk() {
		...
		if (form.user_NICK.value == "" || form.user_NICK.value.length < 0) {
			...
			url2 = "&user_id="
			// alert(url1 + form.user_NICK.value + url2 + form.ID.value);
			window.open(url1 + form.user_NICK.value + url2 + form.ID.value, "닉네임 확인",
		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				...
				<div class="card-body">
					...
					<form action="./loginController" method="post" name="wfrm">
					<input type="hidden" name="action" value="userupdate_ok" />
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									...
									value="<%=address[0] %>" placeholder="변경할 주소">
								</div>
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									...
									value="<%=address[1] %>" placeholder="상세 주소 선택 기재 사항">
								</div>
							</div>
						</div>
