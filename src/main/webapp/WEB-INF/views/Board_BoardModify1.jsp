...
<div class="container">
	...
	<div class="con_txt">
		<form action="./ComBoardController" method="post" name="mfrm">
			...
			<div class="contents_sub">	
				...
				<div class="btn_area">
					<div class="align_left">
						<input type="button" value="목록" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./ComBoardController?action=list1'" />
						<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./ComBoardController?action=view&seq=<%=seq %>'" />
					</div>
