					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown02">
								<li><a class="dropdown-item" href="news.jsp">국내</a></li>
								<li><a class="dropdown-item" href="news_world.jsp">해외</a></li>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown05">
								<li><a class="dropdown-item" href="blog-sidebar.jsp">회원
										가입 정보</a></li>
								<li><a class="dropdown-item" href="blog-sidebar.jsp">내가
										쓴 글 보기</a></li>
							</ul></li>
					</ul>
				</div>
