...
<%
	...
	for( BoardTO to : lists ) {
		...
		sbHtml.append( "	<a href='Board_BoardView1.jsp?seq=" + seq + "'>" + subject + "</a>&nbsp;" );
		if( wgap == 0 ) {
...
<% if(session.getAttribute("user_id") != null ){
	...
	<div class="align_right">
			<input type="button" value="쓰기" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='Board_BoardWrite1.jsp'" />
		</div>
<% 	
}
