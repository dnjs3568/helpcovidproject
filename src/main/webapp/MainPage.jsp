					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown05">
								<li><a class="dropdown-item" href="blog-sidebar.jsp">확진자 / 자가격리자</a></li>
								<li><a class="dropdown-item" href="Board_BoardList.jsp">자유게시판</a></li>
							</ul>
						</li>
				...
				<div class="col-lg-12">
					<div class="feature-block d-lg-flex">
						...
						<div class="feature-item mb-5 mb-lg-0">
							...
							<button class="btn-hover color-8" onclick="location.href='Board_BoardList.jsp'">자유 게시판</button>
						</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-4">
					<div class="about-content pl-4 mt-4 mt-lg-0">
						...
						<p class="mt-4 mb-5">
							사적 모임 인원 전국 6 인 유지 <br>영업 시간 22 시로 완화 즉시 시행(2.19~3.13)
						</p>
